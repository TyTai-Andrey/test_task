            ...
            <div className="swapper">
                ...
                <div className="another_blogers">
                    ...
                    <div className="another_blogers-row">
                        <div className="another_blogers-items" style={{right: `${trackState*331}px`}}>
                        {
                        ...
                        <div className="another_blogers-nav">
                            <div id="arrow-left"
                            onClick={()=>{(trackState===0) ? setTrackState(0) : setTrackState(trackState-1)}}
                            >
                            ...
                            <div className="range">
                                <span className="track" style={{left: `${trackState*40}px`}}></span>
                            </div>
                            <div id="arrow-right" 
                            onClick={()=>{(trackState===4) ? setTrackState(4) : setTrackState(trackState+1)}}
                            >
                                <svg width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
